...
function App() {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'} font-poppins transition-colors duration-500`}>
      <motion.button
        onClick={toggleTheme}
      ...
      >
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
          <h2 className="text-2xl font-semibold mb-6 text-teal-600 dark:text-teal-400">Team</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-left">
            <div>
              <h3 className="text-xl font-semibold mb-2 text-teal-600 dark:text-teal-400">Group Members</h3>
              <p className="text-lg text-gray-800 dark:text-gray-100">
                Tushar Raju Nagpure (Roll No: 211106069)<br />
                Saurabh Santosh Naik (Roll No: 221206009)<br />
                Riya Rajendra Dhargalkar (Roll No: 211106049)
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-2 text-teal-600 dark:text-teal-400">Guide</h3>
              <p className="text-lg text-gray-800 dark:text-gray-100">
      ...
      >
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
          <h2 className="text-3xl font-semibold mb-6 text-teal-600 dark:text-teal-400">Upload Rainy Image</h2>
          <div
            className={`border-2 ${isDragging ? 'border-teal-500' : 'border-gray-300'} border-dashed rounded-xl p-6 mb-6 text-center transition-colors duration-300 relative`}
          ...
          {preview && (
            <div className="mb-6 relative">
              <img src={preview} alt="Uploaded preview" className="max-w-full max-h-64 h-auto rounded-xl mx-auto object-contain" />
              {loading && (
      ...
      {derainedImage && !loading && (
        ...
        >
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
            <h2 className="text-3xl font-semibold mb-6 text-teal-600 dark:text-teal-400">Results</h2>
            <div className="relative rounded-xl overflow-hidden shadow-lg">
              <ReactCompareSlider
                itemOne={<ReactCompareSliderImage src={preview} alt="Rainy Image" style={{ objectFit: 'contain' }} />}
                itemTwo={<ReactCompareSliderImage src={derainedImage} alt="Derained Image" style={{ objectFit: 'contain' }} />}
